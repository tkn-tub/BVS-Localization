...
public:
  ...
  */
  ...
  Ptr<NanoNetDevice> GetNanoNetDevice() const; // Getter for the device

  /**
  * \param channel a biomarker channel pointer.
  *
  * This function sets the according BiomarkerChannel pointer.
  */
  void SetBiomarkerChannel(Ptr<BiomarkerChannel> channel);

  /**
  * \returns the pointer to the BiomarkerChannel.
  */
